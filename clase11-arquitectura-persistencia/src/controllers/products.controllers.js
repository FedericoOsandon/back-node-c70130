...
class ProductClass {
    ...
    getProdutcs = async (req, res) =>{
        ...
        const { docs, totalPages,hasPrevPage, hasNextPage, prevPage, nextPage } = await productService.get({limit, page, category, sort})               
    ...
    createProdutcs = async (req, res) =>{
        ...
        let respuesta = await productService.create(newProduct)
    ...
    updateProduct = async (req, res) =>{
        ...
        const respuesta = await productService.update(pid, updateProduct)
    ...
    deleteProduct = async (req, res) =>{
        ...
        const respuesta = await productService.delete(pid)
